...
//     fn elab_typed_syntax<'g>(
//         &self,
//         env: &SolverEnvironment<'db, 'g>,
//     ) -> Result<TrustedTypedSyntax<'db>, ElabError>;
// }

// pub trait ElabSyntaxTask<'db> {
//     async fn elab_syntax_task<'g>(
//         &self,
//         env: &SolverEnvironment<'db, 'g>,
//         ty: RcValue<'db>,
//     ) -> TrustedSyntax<'db>;
...
// impl<'db, T> ElabSyntax<'db> for T
// where
//     T: ElabSyntaxTask<'db> + HasSourceRange<'db> + 'db,
// {
//     fn elab_syntax(
//         &self,
//         env: &SolverEnvironment<'db, 'g>,
